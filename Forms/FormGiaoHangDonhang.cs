...
{
    public partial class FormGiaoHangDonhang : Form
    {
        ...
        public FormGiaoHangDonhang(string MAKH)
        {
            InitializeComponent();
        ...
        private void LoadGDDonHang()
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (MaNhanVien != "" && MaNhanVienGH != "" && TrangThaiDon == "False")
                    {
                        xuly = "Đang Giao Hàng";
                    }
                    ...
                    hinhanh.BackColor = Color.White;
                    hinhanh.BorderRadius = 10;
                    hinhanh.Padding = new Padding(10);
        ...
        private void FormGiaoHangDonhang_Load(object sender, EventArgs e)
        {
