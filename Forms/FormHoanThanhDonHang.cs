...
{
    public partial class FormHoanThanhDonHang : Form
    {
        static TaiKhoanBLL TKBLL = new TaiKhoanBLL();
        //Kết nối
        static SqlConnection conn = TKBLL.Load();
        public string makh { get; set; }
        public FormHoanThanhDonHang(string MAKH)
        {
            InitializeComponent();
        ...
        private void FormHoanThanhDonHang_Load(object sender, EventArgs e)
        {
