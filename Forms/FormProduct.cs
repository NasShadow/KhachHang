...
namespace Login.Forms
{
    public partial class FormProduct : Form
    {
        ...
        public FormProduct(string taikhoan)
        {
            InitializeComponent();
            //Load giao diện hàng
            LoadDataIntoPanel();
        ...
        private void DatHangClick(object sender, EventArgs e, string maSanPham, string tenSanPham, string hinhanhSanPham, string gianhapSanPham, string giabanSanPham, string soluongSanPham)
        {
            ...
            FormQuanLyDanhGia form = new FormQuanLyDanhGia(masp, tensp, hinhanh, gianhap, giaban, soluong, this.account);
            form.ShowDialog();
        }
